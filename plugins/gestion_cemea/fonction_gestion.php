...
function gestion_header_prive($flux) {
	...
	$flux .= '<script type="text/javascript" src="'.url_absolue(find_in_path('js/auto-complete/jquery.auto-complete.min.js')).'"></script>';
	$flux .= '<link rel="stylesheet" href="'.url_absolue(find_in_path('js/auto-complete/jquery.auto-complete.css')).'" type="text/css" media="all" />';

    // L'auto submit du <select> des statuts
    $flux .= '<script type="text/javascript" src="'.url_absolue(find_in_path('js/jquery.formStatut.js')).'"></script>';
  	
    //On ajoute le CSS général du plugin
	$flux .= '<link rel="stylesheet" href="'.url_absolue(find_in_path('gestion_cemea.css')).'" type="text/css" media="all" />';
