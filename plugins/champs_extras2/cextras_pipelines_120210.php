...
function cextras_editer_contenu_objet($flux){
	...
	if ($flux['args']['type']=='article') {
		...
		case 'inscrire_auteur': //--- cote public : modifier un auteur, inscrire a une action
			$taff = array('typepart','codecourtoisie','prenom','fonction','nom_court_institution','nom_long_institution','description_institution','date_naissance','adresse','codepostal','localite','tel1','gsm1','fax1','diffusion','ndiffusion');
			break;
