...
function cextras_editer_contenu_objet($flux){
	...
	if ($flux['args']['type']=='article') {
		...
		case 'editer_auteur': //--- cote admin
			$taff = array('idper','typepart','archive_per','codecourtoisie','prenom','fonction','nom_court_institution','nom_long_institution','description_institution','date_naissance','lieunaissance','adresse','adresse_no','codepostal','localite','tel1','tel2','gsm1','gsm2','fax1','fax2','email2','date_creation','date_maj','statut_form_cemea','statut_anim_cemea','statut_ep','statut_sj','personne_reference','centre_reference','envoi_diffusion','date_debut_diffusion','date_fin_diffusion','diffusion','ndiffusion','adherent', 'demandeur_emploi', 'stage_pratique_animateur', 'stage_pratique_coordinateur_adjoint', 'stage_pratique_coordinateur', 'membre');
			break;
