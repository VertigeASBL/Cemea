...
{
	//--- richir vertige : pas les visiteurs, ecraser la condition
	$cond = 'A.id_auteur=S.id_auteur AND A.statut<\'6forum\' AND S.inscrit=\'\'';
	return sql_allfetsel("S.id_auteur", "spip_auteurs_articles AS S,spip_auteurs AS A", "id_article=$id_article". ($cond ? " AND $cond" : ''));
}
